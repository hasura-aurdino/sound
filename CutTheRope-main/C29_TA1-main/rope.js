class Rope
  {//nlink=number of links 
    //pointa= points of connections
    //Composites.stack()=to create multiple rect bodies and store it in rect var
   //Constraints.create()= it add the contrainst to the chain which connects all the bodies of the chain together like we have strings in a necklace
   //break() helps us break the chain and makes the rope body null
